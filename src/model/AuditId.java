...
/**
 * AuditId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class AuditId implements java.io.Serializable {
	...
	/** full constructor */
	public AuditId(Integer id, Integer staffId, Integer scriptId,
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AuditId))
			return false;
		AuditId castOther = (AuditId) other;
