...
@Controller("chiefeditorquerymanager")
@RequestMapping("/chiefeditor/querymanager")
public class QueryManagerController {
	...
	public String script() {
		return "/chiefeditor/querymanager/scriptsearch";
	}
	...
	public String[][] script(HttpSession session, String title) {
		...
		// 获取当前登陆者的信息
		Staff staff = (Staff) session.getAttribute("g_user");
...
//		}
	...
	public String authorsearch() {
		return "/chiefeditor/querymanager/authorsearch";
	}
	...
	public String authordetail(Model model, int id) {
		...
		return "/chiefeditor/querymanager/authordetail";
	}
