        ...
        <ul id="menu">
            ...
            <li class="childUlLi">
                ...
                <ul>
                    ...
                    <li><a href="financial/usercenter/check" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>查看个人资料</a></li>
                    <li><a href="financial/usercenter/update" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>修改个人资料</a></li>
                    <li><a href="financial/usercenter/password" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>修改密码</a></li>
