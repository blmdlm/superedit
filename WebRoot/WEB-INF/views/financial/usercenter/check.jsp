	...
	<div class="div_from_aoto" style="width: 500px;">
		<FORM>
			<DIV class="control-group">
				...
				<DIV class="controls">
					<INPUT class="input_from" type=text value="${j_user.name}"
						readonly="readonly" />
			...
			<DIV class="control-group">
				...
				<DIV class="controls">
					<INPUT class="input_from" type=text value="${j_user.phone}"
						readonly="readonly" />
					<P class=help-block></P>
				</DIV>
			</DIV>
			<DIV class="control-group">
				...
				<DIV class="controls">
					<INPUT class="input_from" type=text value="${j_user.email}"
						readonly="readonly" />
					<P class=help-block></P>
				</DIV>
			</DIV>
			<DIV class="control-group">
				...
				<DIV class="controls">
					<INPUT class="input_from" type=text
						value="${j_user.publisher.name}" readonly="readonly" />
					<P class=help-block></P>
				</DIV>
			</DIV>
			<DIV class="control-group">
				...
				<DIV class="controls">
					<a href="financial/usercenter/update"><button type="button"
