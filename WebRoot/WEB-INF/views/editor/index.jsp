        ...
        <ul id="menu">
            ...
            <li class="childUlLi">
                ...
                <ul>
                    ...
                    <li><a href="editor/usercenter/password" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>修改密码</a></li>
            ...
            <li class="childUlLi">
                <a href="B_personIfo"  target="menuFrame"> <i class="glyph-icon icon-reorder"></i>作者库</a>
                <ul>
                	<li><a href="editor/authorlib/check" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>作者库</a></li>
    ...
    <div id="layout_right_content" class="layout_right_content">
        ...
        <div class="mian_content">
            <div id="page_content">
                ...
                <!--引入界面-->
                <iframe id="menuFrame" name="menuFrame" src="res/img/girl03.jpg" style="overflow:visible;"
