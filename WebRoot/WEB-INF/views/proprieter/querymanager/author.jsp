...
<html>
  <head>
	...
	<link rel="stylesheet" href="res/css/proprieter/querymanager/author.css" type="text/css" media="screen" />
	<script type="text/javascript" src="res/js/jquery-1.11.1.min.js"></script>
  	<script type="text/javascript" src="res/js/bootstrap.min.js"></script>
  	<script type="text/javascript" src="res/js/jput.min.js"></script>
  	<script type="text/javascript" src="res/js/proprieter/querymanager/author.js"></script>
  ...
  <div class="col-lg-6 searchbox"  >
    <div class="input-group">
      <input type="text" id="input" class="form-control" placeholder="Search for author">
      <span class="input-group-btn">
        <button class="btn btn-default" type="button" onclick="showResult()">Go!</button>
      </span>
    </div>
  </div>
 ...
 onclick="change(${result[0]})" >查看稿件</button></td>
