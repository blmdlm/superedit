        ...
        <ul id="menu">
            ...
            <li class="childUlLi">
                ...
                <ul>
                    ...
                    <li><a href="chiefeditor/usercenter/check" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>查看个人资料</a></li>
                    <li><a href="chiefeditor/usercenter/update" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>修改个人资料</a></li>
                    <li><a href="chiefeditor/usercenter/password" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>修改密码</a></li>
            ...
            <li class="childUlLi">
                ...
                <ul>
                    <li><a href="chiefeditor/usermanager/check" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>查看账户</a></li>
                    <li><a href="chiefeditor/usermanager/create" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>创建账户</a></li>
                    <li><a href="chiefeditor/usermanager/delete" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>删除账户</a></li>
                </ul>
            </li> 
            <li class="childUlLi">
                <a href="B_download" target="menuFrame"> <i class="glyph-icon icon-reorder"></i>查询管理</a>
                <ul>
					<li><a href="chiefeditor/querymanager/authorsearch" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>查询作者</a></li>
					<li><a href="chiefeditor/querymanager/scriptsearch" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>查询稿件</a></li>
                </ul>
            </li>
<!-- 			<li class="childUlLi">
