...
<link rel="stylesheet" href="res/css/chiefeditor/usermanager/check.css" type="text/css" media="screen" />
...
<div class="div_from_aoto" style="width: 80%;">
    ...
    <div class="row-fluid" id="a1">
       ...
       <div class="twobutton">
            ...
            <a href="chiefeditor/usermanager/delete/${staff.id}"><button type="button" class="btn btn-default " >删除</button></a>
        </div>
		</c:forEach>
    </div>
    ...
    <div class="row-fluid" id="a3">
        <p class="title">排版人员</p>
       <c:forEach items="${staffs04}" varStatus="i" var="staff">
       <div class="twobutton">
            <button type="button" class="btn  btn-primary" style="width:130px" disabled="disabled">${staff.name}</button>
            <a href="chiefeditor/usermanager/delete/${staff.id}"><button type="button" class="btn btn-default " >删除</button></a> 
        </div>
