	...
	<div class="div_from_aoto" style="width: 500px;">
		<FORM>
			<DIV class="control-group">
				...
				<DIV class="controls">
					<INPUT class="input_from" type=text value="${g_user.name}"
						readonly="readonly" />
			...
			<DIV class="control-group">
				...
				<DIV class="controls">
					<INPUT class="input_from" type=text value="${g_user.phone}"
						readonly="readonly" />
					<P class=help-block></P>
				</DIV>
			</DIV>
			<DIV class="control-group">
				...
				<DIV class="controls">
					<INPUT class="input_from" type=text value="${g_user.email}"
						readonly="readonly" />
					<P class=help-block></P>
				</DIV>
			</DIV>
			<DIV class="control-group">
				...
				<DIV class="controls">
					<INPUT class="input_from" type=text
						value="${g_user.publisher.name}" readonly="readonly" />
					<P class=help-block></P>
				</DIV>
			</DIV>
			
			<DIV class="control-group">
				<LABEL class="laber_from">杂志社:</LABEL>
				<DIV class="controls">
					<INPUT class="input_from" type=text
			...
			<DIV class="control-group">
				...
				<DIV class="controls">
					<a href="chiefeditor/usercenter/update"><button type="button"
